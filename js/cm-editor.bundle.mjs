...
// js/cm-editor.mjs
var mkHighlight = HighlightStyle.define([
  { tag: tags.heading1, color: "#007AFF", fontWeight: "700", fontSize: "1.75em" },
  { tag: tags.heading2, color: "#007AFF", fontWeight: "700", fontSize: "1.35em" },
  { tag: tags.heading3, color: "#007AFF", fontWeight: "600", fontSize: "1.1em" },
  { tag: tags.heading4, color: "#007AFF", fontWeight: "600", fontSize: "0.9375em" },
  { tag: tags.heading5, color: "#007AFF", fontWeight: "600" },
  { tag: tags.heading6, color: "#007AFF", fontWeight: "600" },
  { tag: tags.strong, fontWeight: "700", color: "var(--ios-text-primary)" },
  { tag: tags.emphasis, fontStyle: "italic", color: "var(--ios-text-secondary)" },
  { tag: tags.strikethrough, textDecoration: "line-through", color: "var(--ios-text-tertiary)" },
  { tag: tags.link, color: "#007AFF", textDecoration: "underline" },
  { tag: tags.url, color: "#007AFF", fontSize: "0.875em" },
  {
    tag: tags.monospace,
  ...
  { tag: tags.quote, color: "#8e8e93" },
  /* 勿用 transparent：解析易把 ** 内的 * 标成 list，会留下大块“空白”占位 */
  { tag: tags.list, color: "#8e8e93" },
  { tag: tags.meta, color: "var(--ios-text-tertiary)", fontSize: "0.8em" },
  { tag: tags.comment, color: "#8e8e93" },
  { tag: tags.keyword, color: "#AF52DE" },
  { tag: tags.string, color: "#32D74B" },
  { tag: tags.number, color: "#FF9F0A" },
  { tag: tags.operator, color: "#FF453A" },
  { tag: tags.punctuation, color: "var(--ios-text-tertiary)" },
  { tag: tags.content, color: "var(--ios-text-secondary)" }
]);
function createMarkdownEditor(container, initialText, hooks) {
  const extensions = [
    history(),
    markdown({
...
var obsidianTheme = EditorView.theme(
  {
    "&": {
